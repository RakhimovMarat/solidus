...
ActiveRecord::Schema[7.1].define(version: 2025_01_24_205751) do
  ...
  create_table "spree_stock_items", force: :cascade do |t|
    ...
    t.index ["variant_id", "stock_location_id"], name: "index_spree_stock_items_on_variant_id_and_stock_location_id", unique: true, where: "deleted_at is null /*application='MyStore'*/"
  end
